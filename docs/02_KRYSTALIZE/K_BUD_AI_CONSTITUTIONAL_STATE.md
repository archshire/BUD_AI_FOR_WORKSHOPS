...
| LT-020 | The Bud AI MVP uses voice and text input only; participant video is excluded from the MVP interface and AI input path. | Human clarification | 2026-07-25 | This narrows scope and protects latency, privacy, bandwidth, and implementation focus. |
