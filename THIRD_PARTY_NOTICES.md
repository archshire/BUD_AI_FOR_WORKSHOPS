...
The root `LICENSE` applies to original Bud AI source code and documentation
...
- faster-whisper and its model files.
- NLLB translation model files.
...
the exact versions, source URLs, and license terms for these items here and
confirm that the included image assets may be redistributed.
